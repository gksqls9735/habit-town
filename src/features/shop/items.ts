...
const upgradeShopItems: (GoalCapacityShopItem | InventoryCapacityShopItem)[] = [
  {
    ...
    id: 'goal-slot-expansion',
    image: require('../../../assets/images/icons/shop/goal-slot-expansion-icon.png'),
    kind: 'goal-capacity',
    name: '목표 슬롯 추가',
    price: 1000,
    slotIncrease: 1,
  ...
  },
  {
    ...
    image: require('../../../assets/images/icons/shop/inventory-expansion-icon.png'),
    kind: 'inventory-capacity',
    name: '가방 확장하기',
    price: 1000,
  ...
  },
  {
    ...
    image: require('../../../assets/images/icons/shop/decor-inventory-expansion-icon.png'),
    kind: 'inventory-capacity',
    name: '꾸미기 가방 확장하기',
    price: 1000,
    slotIncrease: inventoryExpansionSlotCount,
